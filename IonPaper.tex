...
% Results from the roof mounted antenna split configuration will be reported
% here. This subsection should compare the paired channel behavior for the
% B210 and KrakenSDR when both channels receive the same antenna signal.
