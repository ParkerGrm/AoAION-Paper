...
Two repeatability checks were performed. In the first check, two recordings were separated by a full B210 power cycle. The measured phase bias changed from $-1.67^\circ$ to $-1.68^\circ$, a difference of $0.01^\circ$. In the second check, the receiver was operated for two hours before repeating the power cycle test. The measured phase bias was unchanged at $-2.29^\circ$. These results, summarized in Table~\ref{tab:b210_bias_stability}, indicate that the mean inter channel phase bias remained stable at the sub degree level for the tested receiver configuration.
